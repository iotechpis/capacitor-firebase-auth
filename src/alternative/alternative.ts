...
import {
    AppleSignInResult, FacebookSignInResult, GoogleSignInResult, PhoneSignInResult, 
    SignInResult, TwitterSignInResult
} from '../definitions';
import { UserCredential, GoogleAuthProvider, FacebookAuthProvider, TwitterAuthProvider, PhoneAuthProvider, getAuth, signInWithCredential, OAuthProvider } from 'firebase/auth';
 ...
 */
export const cfaSignIn = (providerId: string): Observable<{ userCredential: UserCredential, result: SignInResult }> => {
